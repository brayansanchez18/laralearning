<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    <input wire:model.live="search" class="w-full border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" placeholder="Search">
    ...
    @if($search)
        <ul class="absolute z-50 left-0 w-full bg-white mt-1 rounded-lg overflow-hidden">
            ...
            @empty
                <li class="leading-7 px-5 text-sm cursor-pointer hover:bg-gray-300">
                <i class="fas fa-frown mr-2 text-red-500"></i>
