<x-app-layout>
    <div>
        <section class="bg-gray-700 mb-4 shadow-xl">
            <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="text-white py-10">
                    <h1 class="text-3xl mb-2">{{$course->title}}</h1>
                    <h2 class="text-xl mb-2 mt-2">{{$course->subtitle}}</h2>

                    <p class="mb-2"><i class="fas fa-layer-group"></i> Nivel:{{$course->level->name}}</p>
                    <p class="mb-2"><i class="fas fa-tag"></i> Categoria: {{$course->category->name}}</p>
                    <p class="mb-2"><i class="fas fa-user-graduate"></i> Matriculados: {{$course->students_count}}</p>
        ...
        <section class="container mb-6">
            <div class="card-body">
                <h1 class="font-bold text-3xl text-gray-800 mb-3">Descripción</h1>
        ...
        <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {{-- Review --}}
            {{-- TODO: TRABAJAR EN LAS RESEÑAS DEL CURSO --}}
        ...
        <div class="order-1 lg:order-2">
            ...
            <section class="card mb-4">
                ...
                @can('enrolled', $course )
                    <a class="btn btn-primary btn-primary:hover btn-block mt-4" href="{{route('courses.status', $course )}}">Continuar con el curso</a>
                @else
                    ...
                    @else
                        <p class="text-2xl font-bold text-gray-500 mt-3 mb-2 text-center">US$ {{$course->price->value}}</p>
                        <a class="btn btn-primary btn-primary:hover btn-block mt-4" href="#">Adquirir este curso</a>
                    @endif
            ...
            <aside class="hidden lg:block">
                @foreach($similares as $similar)
                    <article class="rounded overflow-hidden flex mb-6">
